        ...
        <>
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    height: {sm: '65px',md: '80px', xl: '116px'}
                }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', maxWidth: '1440px', px: '100px' }}>
                        <Box sx={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                            <Box sx={{ display: 'flex' }}>
                                <Box sx={{ maxWidth: { md: '35px', xl: '50px', sm: '30px' }, width: '100%', borderRadius: '50%' }} component={'img'} src={Logo} />
                            </Box>
                            <Box sx={{ display: 'flex' }}>
                        ...
                        <Box sx={{ display: 'flex', gap: {sm: '10px', md: '28px'} }}>
                            <Button variant='outlined' sx={{ color: 'black', fontSize: {sm: '10px',md: '13px', xl: '16px'}, width: '100%' }}>Login</Button>
                            <Button variant='contained' color='success' sx={{ fontSize: {sm: '10px',md: '13px', xl: '16px'}, width: '100%'}}>Register</Button>
                        </Box>
                    </Box>
                </Box>
            </Box>
